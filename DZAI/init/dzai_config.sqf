...
DZAI_heliTypes = ["UH1H_DZ","UH60M_EP1","MH60S","Mi17_CDF","CH_47F_EP1_DZ","UH1Y_DZ","Ka137_MG_PMC","AN2_DZ","AH6X_DZ","GNT_C185C","pook_H13_gunship_UNO","pook_H13_transport_GUE"];	
...
DZAI_vehTypes = ["UAZ_Unarmed_TK_EP1","UAZ_Unarmed_TK_CIV_EP1","UAZ_Unarmed_UN_EP1","UAZ_CDF","UAZ_INS","UAZ_RU"];
...
DZAI_launcherTypes = ["RPG7V","RPG18","Mk13_EP1","M79_EP1"];	
