...
DZAI_metalBars = [["ItemSilverBar",0.50],["ItemSilverBar10oz",0.60],["ItemGoldBar",0.70],["ItemGoldBar10oz",0.80],["ItemBriefcase100oz",0.05]];
DZAI_metalBarNum = 7;		//Maximum number of metal bars to generate
